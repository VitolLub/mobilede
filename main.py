...
class GbabMain:
    ...
    def start(self):
        models_arr = [1400, 25650, 113, 25300, 25100, 25200, 24500, 24400, 24200, 24100, 135, 189, 23825, 23800, 23600,
                      23500, 23100, 100, 188,
                      23000, 22900, 22500, 22000, 21800, 125, 21700, 21600, 20700, 20200, 20100, 20000, 4, 19800, 19600,
                      19300,
                      149, 19000, 18975, 18875, 18700, 17900, 17700, 17500, 30011, 17300, 17200, 137, 16800, 16700,
                      16600, 15900, 16200,
                      15500, 15400, 15200, 14845, 14800, 14700, 14600, 14400, 13900, 13450, 13450, 12600, 12400, 12100,
                      11900, 11650, 11600,
                      11050, 11000, 10850, 186, 122, 9900, 204, 205, 9000, 8800, 172, 8800, 8600, 235, 255, 7700, 31864,
                      7400, 7000, 6800, 6600, 3,
    ...
    def run(self):
        schedule.every().day.at("14:39").do(self.start)
        while True:
            print('wait')
